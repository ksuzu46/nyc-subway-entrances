/******************************************************************************
  ...
  Description    : An implementation for the subway-system class
  Purpose        : To implement subway-system class
...
void SubwaySystem::list_stations_of_route(ostream &out,const route_id& route) const{
    ...
    for(const auto &i:routes){
        if(i.routes==(1UL<<_route_set|1UL>>(_route_set&mask)))  //route is
            // identical
