/******************************************************************************
  ...
  Description    : Interface file for the subway-portal object
...
class SubwayPortal
{
    ...
    /** subway-portal() is a parametrized constructor which reads a line of
    ...
    /** subway-portal() is a copy constructor
