/******************************************************************************
  ...
  In essence, you create a Command object and then repeatedly call
...
typedef enum
{
    list_route_stations_cmmd = 0,
    list_all_stations_cmmd,
    list_station_portals_cmmd,
    list_routes_cmmd,
    nearest_routes_cmmd,
    nearest_portal_cmmd,
    bad_cmmd,
...
class Command
{
     ...
     * if list_route_stations_cmmd, then line_identifier
     * if list_all_stations_cmmd, then nothing
     * if list_portals_cmmd, then station_name
     * if list_routes_cmmd, then portal_name
